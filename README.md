...
3. **That same address becomes a Universal Account.** Particle's V2 SDK upgrades the Magic EOA **in place** via EIP-7702 — same address before and after. The app asserts `UA address == Magic EOA` on every login and logs the invariant.
